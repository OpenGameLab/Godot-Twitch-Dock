...
var info = TwitchUser.new()


@export var client_id : String = info.your_client_id
# The name of the channel we want to connect to.
@export var channel : String = info.your_channel
# The username of the bot account.
@export var username : String = info.your_username
